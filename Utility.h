...
namespace Utility
{
  ...
  */
  ...
  /** 
     ...
     *  - si le res > 0 alros le point est a gauche : sens des aiguilles d'une montre
     *  - si le res < 0 alros le point est a droite : sens contraire des aiguilles d'une montre
